...
function Make(H) {
  ...
  var create = function (sz) {
    var sz$1 = sz < 7 ? 7 : sz;
    var sz$2 = sz$1 > 1073741823 ? 1073741823 : sz$1;
    return /* record */[
  ...
  var next_sz = function (n) {
    return Caml_primitive.caml_int_min((Caml_int32.imul(3, n) / 2 | 0) + 3 | 0, 1073741823);
  };
  ...
  var add_aux = function (t, setter, d, h, index) {
    ...
    while(true) {
      var i = _i;
      if (i >= sz) {
        var newsz = Caml_primitive.caml_int_min((Caml_int32.imul(3, sz) / 2 | 0) + 3 | 0, 1073741822);
        if (newsz <= sz) {
          throw [
