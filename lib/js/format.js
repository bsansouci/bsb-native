...
function break_new_line(state, offset, width) {
  ...
  state[/* pp_is_new_line */10] = /* boolean */1;
  ...
  if (typeof param === "number") {
    ...
    switch (param.tag | 0) {
      case 0 : 
          ...
          state[/* pp_is_new_line */10] = /* boolean */0;
          return /* () */0;
      case 1 : 
          var off = param[1];
          var n = param[0];
...
function pp_open_box_gen(state, indent, br_ty) {
  ...
  if (state[/* pp_curr_depth */13] < state[/* pp_max_boxes */14]) {
    ...
    return scan_push(state, /* boolean */0, elem);
...
function pp_print_break(state, width, offset) {
  if (state[/* pp_curr_depth */13] < state[/* pp_max_boxes */14]) {
    ...
    return scan_push(state, /* boolean */1, elem);
  } else {
    return 0;
  }
}
...
function pp_make_formatter(f, g, h, i) {
  ...
  return /* record */[
          ...
          /* pp_out_newline */h,
          /* pp_out_spaces */i,
          /* pp_print_tags : boolean */0,
          /* pp_mark_tags : boolean */0,
...
function flush_str_formatter() {
  pp_flush_queue(str_formatter, /* boolean */0);
...
function bprintf(b, param) {
  var k = function (ppf, acc) {
    output_acc(ppf, acc);
    return pp_flush_queue(ppf, /* boolean */0);
  };
