...
function get_method_label(table, name) {
  ...
  if (match !== undefined) {
    ...
    table[/* methods_by_label */3] = Belt_MapInt.set(table[/* methods_by_label */3], label, /* boolean */1);
    return label;
  }
}
...
function narrow(table, vars, virt_meths, concr_meths) {
  ...
  List.iter2((function (met, label) {
          ...
          by_label[0] = Belt_MapInt.set(by_label[0], label, Belt_MapInt.getWithDefault(table[/* methods_by_label */3], label, /* boolean */1));
          return /* () */0;
        }), concr_meths$1, concr_meth_labs);
  List.iter2((function (met, label) {
          by_name[0] = Belt_MapString.set(by_name[0], met, label);
          by_label[0] = Belt_MapInt.set(by_label[0], label, /* boolean */0);
          return /* () */0;
...
function create_table(public_methods) {
  if (public_methods === 0) {
    ...
    $$Array.iteri((function (i, met) {
            ...
            table[/* methods_by_label */3] = Belt_MapInt.set(table[/* methods_by_label */3], lab, /* boolean */1);
            return /* () */0;
          }), public_methods);
    return table;
  }
